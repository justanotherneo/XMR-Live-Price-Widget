...
volume_label.grid(row=1, column=1, padx=20, pady=5)

# Add a small footer with "Powered by diadata.org"
footer_label = tk.Label(root, text="Powered by CRZYCYBR. Follow on YouTube for the 64 Core XMR Miner build", font=("Helvetica", 10), fg="#777777", bg="#1e1e1e")
